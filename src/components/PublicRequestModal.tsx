...
export default function PublicRequestModal({ onClose, onSubmitSuccess, eventId, initialRole }: PublicRequestModalProps) {
  ...
  const baseRoles = [
    ...
    { id: "PROFISSIONAL DA EDUCAÇÃO", label: "Profissional da Educação", desc: "Corpo Docente, Pedagógico ou Técnico", icon: BookOpen, color: "text-cyan-500 bg-cyan-50 dark:bg-cyan-950/40 border-cyan-200 dark:border-cyan-800" },
